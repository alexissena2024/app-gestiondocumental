           ...
           Route::delete('/Modelo/delete',[ModeloController::class, 'delete']);
            ...
            Route::delete('/Memoria/delete',[MemoriaController::class, 'delete']);
              ...
              Route::delete('/Localcolegio/delete',[LocalcolegioController::class, 'delete']);
               ...
               Route::get('/Tipoelemento/getdata',[TipoelementoController::class, 'getData']);
               Route::post('/Tipoelemento/save', [TipoelementoController::class, 'save']);
               Route::put('/Tipoelemento/update', [TipoelementoController::class, 'actualizar']);
               Route::delete('/Tipoelemento/delete',[TipoelementoController::class, 'delete']);